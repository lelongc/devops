# 🏛 Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation) - System Design Interview Volume 1 Chuyên Sâu

> 💡 **Bản chất 1 câu**: Bài học phân tích thiết kế hệ thống thực chiến cho **Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)**, cung cấp bức tranh toàn cảnh từ luồng truy vấn sơ khởi đến hạ tầng chịu tải hàng triệu người dùng (High Scalability, Fault Tolerance & Low Latency).  
> 🎯 **Trọng tâm thực chiến DevOps & System Architect**: Các con số độ trễ quan trọng mọi kỹ sư cần thuộc lòng (L1/L2 Cache, RAM, SSD, Network RTT), tính toán dung lượng đĩa, băng thông, QPS / RPS và chuẩn SLA/SLO/SLI 99.99%.

---

## 1. 🧠 Hình Hình Dung Nhanh Cho Người Mới (Intuitive Mindset)

Hãy tưởng tượng việc xây dựng hệ thống **Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)** giống như việc quy hoạch một trung tâm logistics hiện đại hàng đầu thế giới:
- **Khách hàng (Client Users)** liên tục gửi hàng ngàn yêu cầu vận chuyển hàng hóa mỗi giây.
- **Hạ tầng (Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation))** sử dụng hệ thống băng chuyền phân loại tự động, kho chứa tạm thời (Caching), phân luồng giao thông thông minh (Load Balancer) và đội xe giao hàng bất đồng bộ (Message Queues & Background Workers).
...
### 🖼 Sơ Đồ Đồ Họa Kiến Trúc Gốc Trích Xuất Từ Sách System Design Interview (Trang 34):

![Sơ đồ kiến trúc Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)](../images/page_34_full.png)
...
| :--- | :--- | :--- | :--- |
| **`Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)`** | `System Design` | Mô hình thiết kế chuẩn mực giải quyết bài toán quy mô khổng lồ | `Kiến trúc Microservices, Distributed Systems` |
...
> **Q: Hãy phân tích bài toán Đánh đổi (Trade-offs) lớn nhất khi thiết kế Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)?**  
...
- [x] Hiểu rõ mục tiêu thiết kế và sơ đồ luồng dữ liệu chính của **Chương 2: Ước Tính Nhanh Hệ Thống (Back-of-the-Envelope Estimation)**.
