# 🏛 Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener) - System Design Interview Volume 1 Chuyên Sâu

> 💡 **Bản chất 1 câu**: Bài học phân tích thiết kế hệ thống thực chiến cho **Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)**, cung cấp bức tranh toàn cảnh từ luồng truy vấn sơ khởi đến hạ tầng chịu tải hàng triệu người dùng (High Scalability, Fault Tolerance & Low Latency).  
> 🎯 **Trọng tâm thực chiến DevOps & System Architect**: Xây dựng dịch vụ rút gọn URL như bit.ly: Chuyển hướng HTTP 301 vs 302, thuật toán mã hóa Base62 mã ngắn 7 ký tự, Caching & Database Sharding xử lý tỷ lệ Read/Write 10:1.

---

## 1. 🧠 Hình Hình Dung Nhanh Cho Người Mới (Intuitive Mindset)

Hãy tưởng tượng việc xây dựng hệ thống **Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)** giống như việc quy hoạch một trung tâm logistics hiện đại hàng đầu thế giới:
- **Khách hàng (Client Users)** liên tục gửi hàng ngàn yêu cầu vận chuyển hàng hóa mỗi giây.
- **Hạ tầng (Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener))** sử dụng hệ thống băng chuyền phân loại tự động, kho chứa tạm thời (Caching), phân luồng giao thông thông minh (Load Balancer) và đội xe giao hàng bất đồng bộ (Message Queues & Background Workers).
...
### 🖼 Sơ Đồ Đồ Họa Kiến Trúc Gốc Trích Xuất Từ Sách System Design Interview (Trang 119):

![Sơ đồ kiến trúc Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)](../images/page_119_full.png)
...
| :--- | :--- | :--- | :--- |
| **`Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)`** | `System Design` | Mô hình thiết kế chuẩn mực giải quyết bài toán quy mô khổng lồ | `Kiến trúc Microservices, Distributed Systems` |
...
> **Q: Hãy phân tích bài toán Đánh đổi (Trade-offs) lớn nhất khi thiết kế Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)?**  
...
- [x] Hiểu rõ mục tiêu thiết kế và sơ đồ luồng dữ liệu chính của **Chương 8: Thiết Kế Hệ Thống Rút Gọn Link (Design a URL Shortener)**.
