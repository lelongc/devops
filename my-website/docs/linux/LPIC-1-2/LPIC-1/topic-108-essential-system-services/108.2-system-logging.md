...
```mermaid
graph TD
    App[Application / Service] -->|Write Log| Journald[Systemd Journald - Binary Logs]
    Journald -->|Forward Log| Syslogd[Rsyslogd - Text Logs]
    Syslogd -->|Write to File| VarLog[/var/log/syslog or /var/log/messages]
```
