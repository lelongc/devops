# Objective 108.2: Quản lý Log Hệ thống (rsyslog, journalctl, logrotate)

> 📚 **Chứng chỉ LPIC-1 (Exam 102-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 291 - 347)  
...
Bài học này cung cấp kiến thức thực chiến sâu sắc về **Objective 108.2: Quản lý Log Hệ thống (rsyslog, journalctl, logrotate)**.
