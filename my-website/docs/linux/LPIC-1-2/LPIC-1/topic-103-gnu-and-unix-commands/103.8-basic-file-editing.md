...
```mermaid
graph TD
    CommandMode[Command / Normal Mode] -->|i / a / o| InsertMode[Insert Mode - Type Text]
    InsertMode -->|ESC| CommandMode
    CommandMode -->|: | ExMode[Ex / Command-Line Mode: wq / q!]
    ExMode -->|Enter / ESC| CommandMode
```
