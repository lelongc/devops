# Objective 103.5: Quản lý Tiến trình (ps, top, kill, tmux)

> 📚 **Chứng chỉ LPIC-1 (Exam 101-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 298 - 356)  
...
Bài học này giúp bạn nắm vững kiến thức chuyên sâu về **Objective 103.5: Quản lý Tiến trình (ps, top, kill, tmux)**. 
