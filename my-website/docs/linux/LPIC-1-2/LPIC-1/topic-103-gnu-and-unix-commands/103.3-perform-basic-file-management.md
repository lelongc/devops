# Objective 103.3: Quản lý File & Thư mục (cp, mv, tar, find)

> 📚 **Chứng chỉ LPIC-1 (Exam 101-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 235 - 275)  
...
Bài học này giúp bạn nắm vững kiến thức chuyên sâu về **Objective 103.3: Quản lý File & Thư mục (cp, mv, tar, find)**. 
...
NOTE
To find empty files we can use: find . -size 0c  or  find . -empty.
