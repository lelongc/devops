# Objective 102.2: Cài đặt và Cấu hình Trình quản lý Boot (GRUB2)

> 📚 **Chứng chỉ LPIC-1 (Exam 101-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 75 - 95)  
...
Bài học này giúp bạn nắm vững kiến thức chuyên sâu về **Objective 102.2: Cài đặt và Cấu hình Trình quản lý Boot (GRUB2)**. 
