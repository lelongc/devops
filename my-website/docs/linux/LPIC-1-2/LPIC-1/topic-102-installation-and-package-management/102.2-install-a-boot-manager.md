...
GRUB2 như người bảo vệ mở cổng: Cho biết danh sách Kernel Linux hiện có để nạp, nếu mất pass root thì ghé tai bảo vệ thêm dòng `init=/bin/bash` để vào nhà thẳng không cần chìa khóa.
