# Objective 102.5: Trình quản lý Gói Red Hat (rpm, yum, dnf)

> 📚 **Chứng chỉ LPIC-1 (Exam 101-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 132 - 157)  
...
Bài học này giúp bạn nắm vững kiến thức chuyên sâu về **Objective 102.5: Trình quản lý Gói Red Hat (rpm, yum, dnf)**. 
