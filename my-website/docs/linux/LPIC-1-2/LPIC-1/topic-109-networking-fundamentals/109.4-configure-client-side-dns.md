# Objective 109.4: Cấu hình DNS Khách (/etc/resolv.conf, systemd-resolved)

> 📚 **Chứng chỉ LPIC-1 (Exam 102-500 Version 5.0)**  
> 📖 **Trích xuất nội dung**: LPI Learning Materials (Trang 472 - 488)  
...
Bài học này cung cấp kiến thức thực chiến sâu sắc về **Objective 109.4: Cấu hình DNS Khách (/etc/resolv.conf, systemd-resolved)**.
