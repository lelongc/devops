...
LVM Snapshots giống như đóng băng thời gian ổ đĩa: Bạn tạo một bản Snapshot trong 1 giây, nếu cập nhật phần mềm bị lỗi hư database thì dùng `lvconvert --merge` để đảo ngược toàn bộ ổ đĩa về đúng mốc thời gian đã đóng băng.
