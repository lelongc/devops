...
Kernel Modules như các plugin của trình duyệt: Khi cần dùng VPN hay Docker thì nạp module `overlay` hay `wireguard` vào RAM, không dùng nữa thì tháo ra để đỡ tốn bộ nhớ.
